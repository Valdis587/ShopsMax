        ...
        <div class="themeModal2__body">
            ...
            <div class="themeModal2__content">
                ...
                <div class="themeModal2__left">
                    <img src="<?php echo $shopsmax['popup-img']['url']; ?>" alt="<?php bloginfo(); ?>">
                </div>
                <div class="themeModal2__right">
                <?php if($shopsmax['popup-short-form']) {  echo do_shortcode($shopsmax['popup-short-form']); } ?>
                </div>
                </div>
            </div>
        </div>
