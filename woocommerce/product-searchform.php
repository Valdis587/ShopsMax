...
<?php
    ...
    ?>
<input plaсeholder="Поиск по товарам" type="search" id="woocommerce-product-search-field-<?php echo isset( $index ) ? absint( $index ) : 0; ?>" class="search-field formshop__input"  value="Поиск по товарам" name="s" />
